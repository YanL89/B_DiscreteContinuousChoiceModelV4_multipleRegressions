...
#yan
dc4Paramsnew = function(x,nparPr,nparReg_Primary, nparReg_Secondary, nparReg_Third){
  betaPr = x[1:nparPr]
  betaReg_Primary = x[(nparPr + 1):(nparPr + nparReg_Primary)]
  betaReg_Secondary = x[(nparPr + nparReg_Primary + 1):(nparPr + nparReg_Primary + nparReg_Secondary)]
  betaReg_Third = x[(nparPr + nparReg_Primary  + nparReg_Secondary + 1):(nparPr + nparReg_Primary + nparReg_Secondary + nparReg_Third)]
  L = vec2mat(c(sqrt(2),x[(nparPr + nparReg_Primary + nparReg_Secondary + nparReg_Third + 1):length(x)]))
  return(list(betaPr = betaPr, betaReg_Primary = betaReg_Primary, betaReg_Secondary = betaReg_Secondary, betaReg_Third = betaReg_Third, L = L))
}
